...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'Portfólio moderno e responsivo desenvolvido com React, TypeScript e Framer Motion.',
    longDescription: 'Portfolio pessoal apresentando projetos, experiência profissional e habilidades técnicas. Construído com React e TypeScript, features animações suaves com Framer Motion e design responsivo com Tailwind CSS.',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=500&h=300&fit=crop',
    technologies: ['React', 'TypeScript', 'Framer Motion', 'Tailwind CSS', 'Vite'],
    github: 'https://github.com/GustavoSilveira1012/portfolio-gustavo',
    demo: '#',
    category: 'web',
  },
]
